							...
							>
								<div className="header-3__video-container">
									{this.props.project.image.length > 1 && (
										<Carousel
											...
											showThumbs={false}
										>
											{this.props.project.image.map(
												(name, index) => (
													<div
														key={index}
														className="header-1__carrousel"
													>
														<Image
															content={name}
															width="100%"
										...
										<React.Fragment>
													...
													{this.props.project.director.title == "Works" ? (
														...
														>
															<a
																className="back-to"
																onMouseOver={() =>
																	this.customFunctionCallOverview(
																		this
																			.props
																			.project
																			.director
											...
											<div className="header-1__container-content-wrapper projects">
												{this.props.project
													.headline && (
													<h1
														className="header-3__container-content-title"
												...
												<div className="header-3__content-wrapper">
													{this.props.project
														.description && (
														<div
															className="fade-up header-3__container-content-description"
															dangerouslySetInnerHTML={{
																__html: this
																	.props
																	.project
								...
								{this.props.project.blocks && (
									<div className="no-blocks">
										<Blocks
											content={this.props.project.blocks}
										/>
									</div>
								)}
							</div>
